-- PURPOSE: SHOW AIDA USAGE BY COURSE
...
select ih_node, term, course_name, course_number, count(course_item_id) as item_count from ai_summary where ai_status = 'Y' group by 1,2,3,4 order by item_count desc 